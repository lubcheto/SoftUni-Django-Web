# Generated by Django 3.1.4 on 2020-12-07 23:01
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_picture', models.ImageField(blank=True, upload_to='private/users')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('sum_of_items', models.DecimalField(decimal_places=2, default=0, max_digits=10)),
